/**
 * WorkContactController is a Java class containing method to run FXML file "WorkContactView".
 * 
...
//		System.out.println(favColor1);
        ...
        TableColumn<Contact, String> title = new TableColumn<Contact, String>("Title");
        TableColumn<Contact, String> phone = new TableColumn<Contact, String>("Phone");
		AddressBook workBook = new AddressBook("Work Contacts");
		contacts = workBook.loadContacts("data/work.csv", fullname);
        ...
        contactTableView.getColumns().addAll(name, title, phone);
